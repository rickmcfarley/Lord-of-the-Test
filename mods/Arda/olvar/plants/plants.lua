...
minetest.register_node("olvar:lorien_grass_1", {
	description = "Lorien Grass",
	drawtype = "plantlike",
	tiles = {"olvar_lorien_grass_1.png"},
	-- use a bigger inventory image
	inventory_image = "olvar_lorien_grass_3.png",
	wield_image = "olvar_lorien_grass_3.png",
	paramtype = "light",
	walkable = false,
	...
	on_place = function(itemstack, placer, pointed_thing)
		...
		local stack = ItemStack("olvar:lorien_grass_"..math.random(1,5))
		local ret = minetest.item_place(stack, placer, pointed_thing)
		return ItemStack("olvar:lorien_grass_1 "..itemstack:get_count()-(1-ret:get_count()))
	end,
})

minetest.register_node("olvar:lorien_grass_2", {
	description = "Lorien Grass",
	drawtype = "plantlike",
	tiles = {"olvar_lorien_grass_2.png"},
	inventory_image = "olvar_lorien_grass_2.png",
	wield_image = "olvar_lorien_grass_2.png",
	paramtype = "light",
	walkable = false,
	buildable_to = true,
	is_ground_content = true,
	drop = "olvar:lorien_grass_1",
...
minetest.register_node("olvar:lorien_grass_3", {
	description = "Lorien Grass",
	drawtype = "plantlike",
	tiles = {"olvar_lorien_grass_3.png"},
	inventory_image = "olvar_lorien_grass_3.png",
	wield_image = "olvar_lorien_grass_3.png",
	paramtype = "light",
	walkable = false,
...
minetest.register_node("olvar:lorien_grass_4", {
	description = "Lorien Grass",
	drawtype = "plantlike",
	tiles = {"olvar_lorien_grass_4.png"},
	inventory_image = "olvar_lorien_grass_4.png",
	wield_image = "olvar_lorien_grass_4.png",
	paramtype = "light",
	walkable = false,
	buildable_to = true,
	is_ground_content = true,

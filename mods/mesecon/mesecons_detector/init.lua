...
minetest.register_node("mesecons_detector:object_detector_off", {
	tiles = {"default_stone.png", "default_stone.png^jeija_object_detector_off.png", "default_stone.png^jeija_object_detector_off.png", "default_stone.png^jeija_object_detector_off.png", "default_stone.png^jeija_object_detector_off.png"},
	paramtype = "light",
	walkable = true,
	groups = {cracky=3},
...
minetest.register_node("mesecons_detector:object_detector_on", {
	tiles = {"default_stone.png", "default_stone.png", "default_stone.png^jeija_object_detector_on.png", "default_stone.png^jeija_object_detector_on.png", "default_stone.png^jeija_object_detector_on.png", "default_stone.png^jeija_object_detector_on.png"},
	paramtype = "light",
	walkable = true,
...
minetest.register_node("mesecons_detector:node_detector_off", {
	tiles = {"default_stone.png", "default_stone.png", "default_stone.png", "default_stone.png", "default_stone.png", "default_stone.png^jeija_node_detector_off.png"},
	paramtype = "light",
	paramtype2 = "facedir",
	walkable = true,
	groups = {cracky=3},
...
minetest.register_node("mesecons_detector:node_detector_on", {
	tiles = {"default_stone.png", "default_stone.png", "default_stone.png", "default_stone.png", "default_stone.png", "default_stone.png^jeija_node_detector_on.png"},
	paramtype = "light",
	paramtype2 = "facedir",
	walkable = true,
	groups = {cracky=3,not_in_creative_inventory=1},
